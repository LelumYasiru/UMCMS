...
<head>
    ...
    <title>Doctor Login - UMCMS</title>
...
<div class="auth-wrapper">
    <div class="card">
        ...
        <h2 style="text-align: center; margin-bottom: 30px; color: var(--primary-color);">Doctor Portal</h2>
        ...
        <form method="POST">
            ...
            <input type="text" name="username" class="input-field" placeholder="Doctor Username" required>

            <label>Password</label>
            <input type="password" name="password" class="input-field" placeholder="Password" required>

            <button type="submit" class="btn btn-secondary" style="width: 100%;">Login as Doctor</button>
        </form>
